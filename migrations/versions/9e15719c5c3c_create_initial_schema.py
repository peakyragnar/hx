...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("checks_allowed", sa.BigInteger(), nullable=False),
        sa.Column("checks_used", sa.BigInteger(), nullable=False, server_default="0"),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("K", sa.BigInteger(), nullable=False),
        sa.Column("R", sa.BigInteger(), nullable=False),
        sa.Column("T", sa.BigInteger(), nullable=True),
        sa.Column("B", sa.BigInteger(), nullable=True),
        sa.Column("seed", sa.BigInteger(), nullable=True),
        sa.Column("bootstrap_seed", sa.BigInteger(), nullable=True),
